...
def main(page: ft.Page):
        def calcular_combustivel(e):
            ...
            if not etanol.value:
                  ...
                  etanol.error_text = ""
                  gasolina.value=float(gasolina.value)
                  etanol.value=float(etanol.value)
        ...
        dlg_modal = ft.AlertDialog(modal=True,title=ft.Text("Melhor abastecer com: "))
        content=ft.Text(size=20, width="bold")
